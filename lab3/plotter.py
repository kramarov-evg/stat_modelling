...
def plot_polygon(specs: dict, show=True, save=False):
    ...
    if show:
        plt.show()
    if save:
        plt.savefig('/home/egor/dev/python/stata/lab3/results/'+specs['method']+'_polygon.png')
    plt.clf()
...
def plot_steps(specs: dict, show=True, save=False):
    ...
    if show:
        plt.show()
    if save:
        plt.savefig('/home/egor/dev/python/stata/lab3/results/'+specs['method']+'_steps.png')
    plt.clf()
